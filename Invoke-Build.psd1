@{
    ...
    AliasesToExport   = @('*')
    NestedModules     = @("$PSScriptRoot/bin/Local/InvokeBuild.dll")
...
# GUID = '90a82802-d601-4961-a1be-e73ca9cf79c4'
...
# Copyright = '(c) Justin Chase. All rights reserved.'
...
# NestedModules = @('bin\Local\netstandard2.0\Invoke_Build.dll')

# # Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
# FunctionsToExport = 'Invoke-Build'
